...
{
    public partial class CreateDocTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "aaaa@gmail.com", "Doc1", "aaaaa" },
                    { 2, "bbbb@gmail.com", "Doc2", "bbbbb" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Pat1", "ccccc" },
                    { 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Pat2", "ddddd" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, "dgsgaefaefaesgfaefg", 10 });

            migrationBuilder.InsertData(
                table: "Prescription_Medicaments",
                columns: new[] { "IdMedicament", "IdPrescription", "Details", "Dose" },
                values: new object[] { 2, 1, "fesfsrggegfe", 12 });
